...
```
nano /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/deep_dive/scripts/deep_dive_map.sh
...
--SS_lib_type RF \
--prep_reference \
--left $(ls -m /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/deep_dive/*"R1_001.fastp-trim.20230519.fastq.gz" | tr -d '[[:space:]]') \
--right $(ls -m /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/deep_dive/*"R2_001.fastp-trim.20230519.fastq.gz" | tr -d '[[:space:]]') \
--est_method RSEM \
--aln_method bowtie2 \
--trinity_mode \
--output_dir /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/deep_dive/align_estimate_abundance


sbatch /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/deep_dive/scripts/deep_dive_map.sh

Submitted batch job 293112 on 20240125 at 12:50
