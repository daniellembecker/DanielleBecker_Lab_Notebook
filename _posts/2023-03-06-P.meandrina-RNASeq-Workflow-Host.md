...
hisat2-build -f /data/putnamlab/dbecks//Becker_E5/Pmean_RNASeq_compare/data/refs/Pocillopora_meandrina_HIv1.assembly.fasta ./Pmean_ref

```
```
sbatch /data/putnamlab/dbecks//Becker_E5/Pmean_RNASeq_compare/scripts/Hisat2_genome_build.sh

Submitted batch job 241403 on 20230310
```
...
```
scp -r danielle_becker@ssh3.hac.uri.edu:/data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/trimmed/script_error /Users/Danielle/Desktop/Putnam_Lab/Becker_E5/Bioinformatics/Output/RNASeq/P.meandrina

```

## Sort and convert sam to bam and remove sam files for space
...
rm /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/mapped/*.sam
done
```
...
array1=($(ls *.bam))  
for i in ${array1[@]}; do
samtools view -F 0x4 /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/mapped/${i} | cut -f 1 | sort | uniq | wc -l > mapped_read_counts
done
...
array1=($(ls *.bam))
for i in ${array1[@]}; do
stringtie -p 48 --rf -e -G /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/refs/Pverr/Pver_genome_assembly_v1.0_modified.gff3 -o /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/counts/${i}.gtf /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/mapped/${i}
done
```
