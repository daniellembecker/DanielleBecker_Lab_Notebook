...
```
Submitted batch job 240088 on 20230307
...
scp -r danielle_becker@ssh3.hac.uri.edu:/data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data//trimmed/trimmed_seq_counts /Users/Danielle/Desktop/Putnam_Lab/Becker_E5/Bioinformatics/Output/RNASeq/P.meandrina/trimmed_fastqc
...
```
module load MultiQC/1.9-intel-2020a-Python-3.8.2
multiqc /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/trimmed/trimmed_qc
```
```
scp -r danielle_becker@ssh3.hac.uri.edu: /data/putnamlab/dbecks/Becker_E5/Pmean_RNASeq_compare/data/trimmed/trimmed_qc/*.html
