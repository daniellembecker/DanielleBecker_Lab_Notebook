...
#To include putative gene information in your Trinity analysis, you can use the --gene_trans_map option
#to make a genes_trans_map file you need to use TransDecoder.LongOrfs and TransDecoder.Predict
...
--transcripts /data/putnamlab/dbecks/Heatwave_A.pul_2022Project/data/trinity/mapped/Apul_denovo  \
--seqType fq \
--SS_lib_type RF \
--prep_reference \
